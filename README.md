...
Below is the website home page, which does not require login.
...
User "John" has "Employee" role and can view only this page after login.
...
User "Mary" has "Employee" and "Manager" role and can view the below page and the special "Leaders" page ("Leaders" page is accessible to Managers only).
...
User "Susan" has "Employee" and "Admin" role and can view the below page and the special "IT System Admins" page ("IT System Admins" page is accessible to Admins only).
